...
for t in tqdm(pipe.scheduler.timesteps):    
    if  0 <= step < timesteps // 2:
        ...
        latents = diffusion_step(pipe, controller, latents, context, t, guidance_scale, train = True)
        ...
        #latents = latents - guidance_scale * lambd[step] * (latents.grad / torch.linalg.norm(latents.grad))
